...
//      <!-- <mat-card-subtitle>Create and manage database forms dynamically</mat-card-subtitle> -->
//    </mat-card-header>
//
//    <mat-card-content>
...
//      <!-- <mat-card-subtitle>{{ selectedRow ? 'Edit Record' : 'Add/Update/Delete Record' }}</mat-card-subtitle> -->
//    </mat-card-header>
//
//    <mat-card-content>
//      <form [formGroup]="form" (ngSubmit)="onSubmit()" class="data-form">
//        <div class="form-grid">
//          <mat-form-field *ngFor="let col of columns" appearance="outline" class="form-field">
//            <mat-label>{{ col.name | titlecase }}</mat-label>
//
//            <!-- Foreign Key Select -->
//            <mat-select *ngIf="col.isForeignKey" [formControlName]="col.name" [disabled]="col.autoIncrement || col.primaryKey">
...
//    matInput [matDatepicker]="picker" [formControlName]="col.name" [readonly]="col.autoIncrement || col.primaryKey">
//            <mat-datepicker-toggle matIconSuffix [for]="picker"></mat-datepicker-toggle>
//            <mat-datepicker #picker></mat-datepicker>
//
//            <!-- Number Fields -->
//            <input *ngIf="!col.isForeignKey && (col.type.includes('int') || col.type.includes('numeric'))"
//    matInput type="number" [formControlName]="col.name" [readonly]="col.autoIncrement || col.primaryKey">
//
//            <!-- Text Fields -->
//            <input *ngIf="!col.isForeignKey && (col.type.includes('char') || col.type.includes('text') || col.type.includes('varchar'))"
//    matInput type="text" [formControlName]="col.name" [readonly]="col.autoIncrement || col.primaryKey">
//
//            <!-- Boolean Fields -->
...
//
//            <!-- Default Fields -->
//            <input *ngIf="!col.isForeignKey && !col.type.includes('int') && !col.type.includes('numeric') && !col.type.includes('char') && !col.type.includes('text') && !col.type.includes('varchar') && !col.type.includes('date') && !col.type.includes('timestamp') && !col.type.includes('boolean') && !col.type.includes('bool')"
//    matInput type="text" [formControlName]="col.name" [readonly]="col.autoIncrement || col.primaryKey">
//
//            <!-- Field Icons -->
...
//      </div>
//      <mat-card-title>Exisiting Data for <i><b>{{ selectedSchema }}.{{ selectedTable }}</b></i></mat-card-title>
//      <!-- <mat-card-subtitle>View and manage {{ selectedSchema }}.{{ selectedTable }} records</mat-card-subtitle> -->
//    </mat-card-header>
//
//    <mat-card-content>
...
//              <mat-header-cell *matHeaderCellDef mat-sort-header>{{ col.name | titlecase }}</mat-header-cell>
//              <mat-cell *matCellDef="let row">{{ row[col.name] }}</mat-cell>
//            </ng-container>
//
//            <ng-container matColumnDef="actions">
//            <mat-header-cell *matHeaderCellDef class="sticky-actions-header">Actions</mat-header-cell>
//              <mat-cell *matCellDef="let row" class="sticky-actions-cell">
//                <div class="row-actions">
//                  <button mat-icon-button color="primary" (click)="editRow(row)" matTooltip="Edit Record">
//                    <mat-icon>edit</mat-icon>
//                  </button>
//                  <button mat-icon-button color="warn" (click)="onDelete(row)" matTooltip="Delete Record">
